                                            ...
                                            @if ($jobapplications->isNotEmpty())
                                                @foreach ($jobapplications as $jobapplication)
                                                    <tr class="active">
                                                        ...
                                                        <td>{{ Carbon\Carbon::parse($jobapplication->job->created_at)->format('m d,Y') }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="action-dots float-end">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><a class="dropdown-item" href="{{ route('jobs.show', $jobapplication->job->id) }}"> <i
                                                                                class="fa fa-eye" aria-hidden="true"></i>
                                                                            View</a>
                                                                    </li>
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('apply.job', $jobapplication->job->id) }}"><i
                  ...
                  $.ajax ({
                         ...
                         type: 'post',
                          ...
                          success: function(response) {
                              window.location.href = "{{ route('account.jobapply') }}";
                          }
                  });
            }
        }
