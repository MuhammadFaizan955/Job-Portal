        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    <a href="{{ route('jobs').'?category='.$category->id }}">{{$category->name}}</h4></a>
                    <p class="mb-0"> <span>50</span> </p>
                </div>
            </div>
                @endforeach
            @endif
...
<p class="mb-0">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('jobs.show', $featurejob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                     ...
                     <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('jobs.show', $latestjob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
