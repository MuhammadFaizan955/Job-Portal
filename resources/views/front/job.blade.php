        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <div class="card border-0 shadow p-4">
                    ...
                    <div class="mb-4">
                        <h2>Location</h2>
                        <input type="text" placeholder="Location" name="location" id="location" class="form-control" value="{{ Request::get('location') }}">
                    </div>
                    ...
                    <div class="mb-4">
                       ...
                       @foreach ($jobtypes as $jobtype)
                         <div class="form-check mb-2">
                            <input {{ (in_array($jobtype->id,$jobtypesArray) ? 'checked' : '') }} class="form-check-input " name="job_type" type="checkbox" value="{{ $jobtype->id }}" id="job-type-{{ $jobtype->id }}">
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('jobs.show', $job->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
