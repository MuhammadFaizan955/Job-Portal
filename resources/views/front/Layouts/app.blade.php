...
<head>
	...
	<title>Sapphire | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">Sapphire</a>
...
<a class="btn btn-outline-primary me-2" href="{{ route('profile') }}" type="submit">Account</a>
				...
				<a class="btn btn-primary" href="{{ route('account.create') }}" type="submit">Post a Job</a>
			</div>
		</div>
	</nav>
</header>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="POST" id="profileImage" name="profileImage">
            @csrf
            <div class="mb-3">
...
<script>
    ...
    $('#profileImage').submit(function(e){
        ...
        var formData = new FormData(this);
            $.ajax({
                type: 'POST',
                url: "{{ route('account.profilepicture') }}",
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
