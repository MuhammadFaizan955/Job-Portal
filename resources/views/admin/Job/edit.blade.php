                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('job') }}">Jobs</a></li>
                                        ...
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea class="form-control" name="responsibility" id="responsibility" cols="5" rows="5"
                                                    placeholder="Responsibility">{{ $job->responsiblity }}</textarea>
                                            </div>
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" placeholder="keywords" id="keywords"
                                                    name="keywords" class="form-control" value="{{ $job->keywords }}">
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" placeholder="Website" id="website"
                                                    name="website" class="form-control" value="{{ $job->website }}">
                                            </div>
                                        </div>
...
@section('scripts')
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === true) {
                        ...
                        $('#title, #category, #Jobtype, #vacancy, #salary, #location, #description, #company_name')
                            .each(function() {
        ...
        //     if (confirm("Are you ready to delete?")) {
        //         $.ajax({
        //             url: "",
        //             data: {
        //                 id: id
